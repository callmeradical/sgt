...
// envelopesRunIDIndex makes fetching envelopes and cascading deletes for a specific run faster.
const envelopesRunIDIndex = `CREATE INDEX IF NOT EXISTS idx_envelopes_run_id ON envelopes(run_id)`

// artifactsRunIDIndex makes fetching artifacts and cascading deletes for a specific run faster.
const artifactsRunIDIndex = `CREATE INDEX IF NOT EXISTS idx_artifacts_run_id ON artifacts(run_id)`

// deliveriesEnvelopeIDIndex makes fetching deliveries for an envelope faster.
